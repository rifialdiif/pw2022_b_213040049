...
<body>
  <nav class="navbar navbar-light navbar-expand-md navigation-clean-search" id="page-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        ...
        <a class="btn btn-light action-button" role="button" data-bs-hover-animate="pulse" href="logout.php" style="background-color: #b8d8f3;">Logout</a>
      </div>
    </div>
  </nav>
      ...
      <div id="content">
        <div class="container-fluid">
          ...
          <div class="row">
            <?php if (empty($anime)) : ?>
              <div class="col-md-12">
                <h1 class="text-center">Anime data not found!</h3>
              </div>
            <?php endif; ?>
          </div>
          <div class="row">
  ...
  <div class="footer-dark mt-5" style="background-color: #b8d8f3;">
    <footer>
      <div class="container">
        <div class="row">
