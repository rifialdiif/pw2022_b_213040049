    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navcol-1">
        <ul class="nav navbar-nav">
          <li class="nav-item" role="presentation"><a class="nav-link" href=" #List">Home</a></li>
  ...
  <div class="photo-gallery">
    <div class="container">
      <div class="intro">
        ...
        <img src="assets/img/banner1.png" class="img-fluid mt-5 mb-5" alt="">
      </div>
      <div class="intro">
        <h2 class="text-center" id="List" style="margin-top: 110px">List Recommendations</h2>
      </div>

      <div class="container">
        <ul class="nav nav-tabs">
          <li class="nav-item"><a class="nav-link active" role="tab" data-toggle="tab" href="#tab-1">Anime</a></li>
          <li class="nav-item"><a class="nav-link" role="tab" data-toggle="tab" href="#tab-2">Manga</a></li>
        </ul>
